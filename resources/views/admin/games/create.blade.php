        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <form method="POST" action="{{ route('admin.games.store') }}">
                    ...
                    <!-- Home Team -->
                    <div class="mb-4">
                        <label for="home_team_id" class="block text-sm font-medium text-gray-900">Home Team</label>
                    ...
                    <!-- Away Team -->
                    <div class="mb-4">
                        <label for="away_team_id" class="block text-sm font-medium text-gray-900">Away Team</label>
                    ...
                    <!-- Kickoff Time -->
                    <div class="mb-4">
                        <label for="kickoff" class="block text-sm font-medium text-gray-900">Kickoff Time</label>
                    ...
                    <!-- Round -->
                    <div class="mb-4">
                        <label for="round" class="block text-sm font-medium text-gray-900">Round</label>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            <label for="home_score" class="block text-sm font-medium text-gray-900">Home Score</label>
                        ...
                        <div>
                            <label for="away_score" class="block text-sm font-medium text-gray-900">Away Score</label>
                    ...
                    <div class="flex justify-end">
                            <button type="submit" class="bg-nfl-primary hover:bg-nfl-secondary text-white font-bold py-2 px-4 rounded">
                            Add Game
                        </button>
                    </div>
                </form>
