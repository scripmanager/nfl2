            ...
            <div class="flex items-center">
                ...
                <div class="hidden sm:ml-6 md:block">
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('entries.index') }}" class="rounded-md px-3 py-2 font-medium {{ Request::routeIs('entries.index','entries.create','entries.store','entries.roster','entries.add-player') ? 'bg-blue-200 text-gray-700' : 'text-gray-300 hover:bg-gray-200 hover:text-gray-700' }}">My Entries</a>
